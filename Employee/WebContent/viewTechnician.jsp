			...
			<div class="col-md-12">
				<div class="text-right">
					<button type="button" class="btn btn-primary"
						onclick="window.location.href='addTech.jsp'">
						...
						<table class="table table-hover table-bordered" id="sampleTable">
							...
							<c:forEach items="${list}" var="tc">
								<tr>
									...
									<td>
										<button class="btn btn-primary btn-sm" type="button" onclick="window.location.href='tcEdit.jsp?id=${tc.getTechid()}'">Edit</button>
									</td>
									<td>
										<button class="btn btn-primary btn-sm" type="button" onclick="window.location.href='techDelete.jsp?id=${tc.getTechid()}'">Delete</button>
									</td>
